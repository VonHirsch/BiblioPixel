...
# todo:
#   change _getBufferFromImage to _bufferImages and modify it to load un-cropped images into _image_buffers
#   create _display_buffers which will be swapped & copied to the screen
#   create new function _copy_imagebuf_to_displaybuf which will
#       copy the correctly offset _image_buffer into the appropriate _display_buffer
#   increment & rotate the offset
...
# Scroll an animated gif file across the screen to simulate animation
class ScrollingImageAnim(Matrix):
    def __init__(
    ...
    def step(self, amt=1):
        ...
        if self.use_file_fps:
            self.internal_delay = 2500  # img[self._curImage][0] / 1000.0
            # print(self.internal_delay)
        self._curImage += 1
